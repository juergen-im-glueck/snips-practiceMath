...
const calculateAnswer = (msg) => {
  ...
  if (answerSlot !== undefined) {
    ...
    if (answer == customData.result) {
      ...
      return {
        text: "Ich habe " + answer + " verstanden. Das ist nicht richtig. Versuch es noch einmal!" + newCustomData.text,
        customData: JSON.stringify(newCustomData)
      };
    }
  } else {
    return {
      text: "Ich habe dich nicht gut verstanden. Versuchs noch einmal! " + customData.text,
